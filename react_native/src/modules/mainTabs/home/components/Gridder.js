    ...
    return (
      <FlatList
        ...
        renderItem={({item, index}) => {
          return (
            <View style={styles.gridderItemContainer}>
              <TouchableOpacity
                style={[
                  styles.buttonGrid,
                ...
                <LinearGradient
                  style={styles.gridderItem}
                  colors={['#2c81d1', '#2e36a6']}
                  start={{x: 0.3, y: 0.5}}>
                  <View style={styles.iconAndNameContainer}>
                    <View style={styles.iconContainer}>
                        <Image 
                          style={styles.icon}
                          source={getGridderSource(item.methodName)}
                          resizeMethod={"resize"}
                        />
                    </View>
                    <View style={styles.descriptionContainer}>
                      <Text style={styles.description}>
                      {global.localization.getLang(item.lang + "_des")}
                      </Text>
                    </View>
                  </View>
